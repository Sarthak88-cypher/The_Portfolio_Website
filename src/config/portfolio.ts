...
const config: PortfolioConfig = {
  ...
  meta: {
    ...
    url: process.env.NEXT_PUBLIC_SITE_URL || 'https://www.saisarthakmohapatra.site',
    ...
    twitterHandle: '@saisarthakmohapatra',
    github: 'https://github.com/Sarthak88-cypher',
    linkedin: 'https://www.linkedin.com/in/saisarthakmohapatra88',
  },
